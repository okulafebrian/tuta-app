<template>
    ...
    <div class="w-3/4 mx-auto pt-6 pb-12">
        <div class="flex items-center justify-between mb-6">
            <div class="text-xl font-semibold">Edit Etalase</div>
            <div>
                <button type="button" @click="updateCollection" :disabled="!validateForm"
...
export default {
    ...
    methods: {
        ...
        updateCollection() {
            this.form.put(route('collections.update', this.collection))
        },
        removeProduct(index) {
