...
export default {
    ...
    methods: {
        ...
        getCities() {
            ...
            this.initial1 ? this.initial1 = false : this.form.city_id = ''
        },
        getDistricts() {
            ...
            this.initial2 ? this.initial2 = false : this.form.district_id = ''
        },
        getZipCodes() {
            ...
            this.initial3 ? this.initial3 = false : this.form.zip_code_id = ''
        },
    },
    watch: {
        'form.province_id'() { this.getCities() },
        'form.city_id'() { this.getDistricts() },
        'form.district_id'() { this.getZipCodes() },
    },
    created() {
        this.getCities()
        this.getDistricts()
